...
const headCells: HeadCell[] = [
    ...
    { id: 'businessName', numeric: true, disablePadding: false, label: 'businessName' },
...
export default function BusinessCustomersTable() {
    ...
    const apiUrl = 'http://185.185.126.15:8080/api/merchants/onboarding/task';
    ...
    useEffect(() => {
        ...
        const getData = async () => {
            ...
            const response = await axios.get(apiUrl, { params: { page: 1, size: 100 } });
            ...
            for (let a = 0; a < objContent.length; a++) {
                ...
                updatedState[a] = createData(objContent[a].id, objContent[a].businessName, objContent[a].title, objContent[a].status);
    ...
    return (
        <div className={classes.root}>
            ...
            <Paper className={classes.paper}>
                <EnhancedTableToolbar numSelected={selected.length} onClick={handleDeleteClick} />
                <TableContainer>
                    <Table
